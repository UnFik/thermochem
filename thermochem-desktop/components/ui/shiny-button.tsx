...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className="font-extrabold font-mono text-[#c76b32] relative block size-full text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
