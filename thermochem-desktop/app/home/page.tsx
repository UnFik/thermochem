...
export default function HomePage() {
  return (
    <div className="min-h-[100dvh] bg-[url('/assets/home-page.png')] bg-cover bg-center">
      <div className="grid grid-cols-2 place-items-center space-x-8 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <a className="hover:cursor-pointer col-span-2 mt-10" href="/soal">
          <img
